...
{
    public class WhisperLiveTranscriptionSession : LiveTranscriptionSession
    {
        ...
        public WhisperLiveTranscriptionSession(string sessionId, WhisperTranscriptionService service, ClientSession clientSession)
        {
            ...
            _whisperFactory = new WhisperSpeechTranscriptorFactory(service.ModelPath);
            _transcriptorFactory = new EchoSharpRealtimeTranscriptorFactory(_whisperFactory, service.VadDetectorFactory, echoSharpOptions: new EchoSharpRealtimeOptions()
            {
        ...
        public override void PushAudioData(ReadOnlyMemory<float> data)
        {
